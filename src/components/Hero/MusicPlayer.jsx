...
const MusicPlayer = () => {
  return (
  <div className="MusicPlaye flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#232A4E] mt-5">
    <div className="upperPart flex items-center justify-between">
        <div className="profile flex">
            <img src={MaskGroup23} alt="" className="w-[2.5rem] h-[2.5rem] border-2 border-white rounded-full" />
    ...
    <div className="lowerPart flex items-center justify-between mt-5">
      <div className="track flex justify-between text-sm text-gray-500 flex-[2]">
        <span>2:30 </span>
        <img src={Group9} alt="track" className="w-[16rem]" />
        <span> 3:47 </span>
      </div>
