...
const Search = () => {
  ...
  return (
    ...
    <div className="left flex-1">
        ...
        src={BackGraphics} alt="backgraphics" className="absolute top-[22rem] left-[-55rem]"/>

        <motion.img src={D1} alt="img" className="w-[16rem] top-[26rem] absolute "/>

        <motion.img src={D2} alt="img" className="w-[9rem] top-[32.7rem] left-[7rem] absolute"/>

        <motion.img src={D3} variants={redimg}
          animate={`${elementIsVisible}`}
          transition={{
            duration: 1.2,
            type: "ease-out",
          }} alt="img" className="w-[9rem] top-[33rem] left-[17rem] absolute"/>

        <motion.img src={D4}  variants={musicimg}
          animate={`${elementIsVisible}`}
          transition={{
            duration: 1,
            type: "ease-out",
          }} alt="img" className="w-[17rem] top-[50rem] left-[2rem] absolute"/>
    </div>
    ...
    <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem]">
        ...
        <div className="searchbar flex justify-start w-[100%]" >
            <input type="text" placeholder="Enter the keywork or URL" 
    ...
    <ReactVisibilitySensor onChange={(isVisible) => setElementIsVisible}>
    <MusicPlayer/>
